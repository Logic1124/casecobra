  ...
  return (
    <div className="bg-slate-50">
          ...
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
              ...
              <p className="mt-8 text-lg lg:pr-10 max-w-prose text-center lg:text-left text-balance md:text-wrap">
                Capture you favorite memories with you own,
                <span>one-of-one</span>phone case.CaseCobra allow you to protect
                you memories , not just you phone case.
              </p>
              ...
              <div className="mt-12 mb-8 flex flex-col sm:flex-row items-center sm:items-start gap-5">
      ...
      <section className="bg-slate-100 py-24">
        ...
        {/*进行至https://www.youtube.com/watch?v=SG82Aqcaaa0  1:20:16*/}
        <div className="pt-16">
          <Reviews />
          {/*进行至https://www.youtube.com/watch?v=SG82Aqcaaa0  1:58:29*/}
        </div>
      </section>
      <section>
